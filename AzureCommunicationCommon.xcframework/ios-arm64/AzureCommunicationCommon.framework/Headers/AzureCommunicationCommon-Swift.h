...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) IdentifierKind * _Nonnull teamsExtensionUser;)
+ (IdentifierKind * _Nonnull)teamsExtensionUser SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly, copy) NSString * _Nullable assertedId;
...
SWIFT_CLASS("_TtC24AzureCommunicationCommon28TeamsExtensionUserIdentifier")
...
/// \param userId The Id of the Microsoft Teams Extension user, i.e. the Entra ID object Id of the user.
///
...
///
/// \param rawId The optional raw id of the Microsoft Teams Phone user identifier.
///
/// \param cloudEnvironment The cloud that the Microsoft Teams Phone user belongs to.
/// A null value translates to the Public cloud.
///
- (nonnull instancetype)initWithUserId:(NSString * _Nonnull)userId tenantId:(NSString * _Nonnull)tenantId resourceId:(NSString * _Nonnull)resourceId rawId:(NSString * _Nullable)rawId cloudEnvironment:(CommunicationCloudEnvironment * _Nonnull)cloudEnvironment OBJC_DESIGNATED_INITIALIZER;
/// Returns a Boolean value that indicates whether the receiver is equal to another given object.
